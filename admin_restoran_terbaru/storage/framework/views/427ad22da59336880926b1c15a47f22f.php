      ...
      <header id="header" class="fixed-top d-flex align-items-cente">
        ...
        >
          <h1 class="logo me-auto me-lg-0">
            ...
            <a href="<?php echo e(route('frontend.index')); ?>">Han`s Restaurant</a>
          </h1>

<nav id="navbar" class="navbar order-last order-lg-0">
    <ul>
      <li><a class="nav-link scrollto active" href="<?php echo e(route('frontend.index')); ?>">Home</a></li>
      <li><a class="nav-link scrollto" href="<?php echo e(route('frontend.abouts')); ?>">Abouts</a></li>
      <li><a class="nav-link scrollto" href="<?php echo e(route('frontend.menu')); ?>">Menu</a></li>
      <li><a class="nav-link scrollto" href="<?php echo e(route('frontend.special')); ?>">Specials</a></li>
      <li><a class="nav-link scrollto" href="<?php echo e(route('frontend.event')); ?>">Events</a></li>
      <li><a class="nav-link scrollto" href="<?php echo e(route('frontend.galery')); ?>">Gallery</a></li>
      <li><a class="nav-link scrollto" href="<?php echo e(route('frontend.galery')); ?>">testimonial</a></li>
...
<!-- End Header --><?php /**PATH /var/www/html/resources/views/layouts/inc/navbar.blade.php ENDPATH**/ ?>