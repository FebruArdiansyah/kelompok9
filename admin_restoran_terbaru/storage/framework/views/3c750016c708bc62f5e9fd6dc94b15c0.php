...
<div class="card">
    <div class="card-header">
        <?php echo e(trans('global.edit')); ?> <?php echo e(trans('cruds.blog.title_singular')); ?>
    ...
    <div class="card-body">
        <form method="POST" action="<?php echo e(route("admin.blogs.update", [$blog->id])); ?>" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control <?php echo e($errors->has('title') ? 'is-invalid' : ''); ?>" type="text" name="title" id="title" value="<?php echo e(old('title', $blog->title)); ?>" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control <?php echo e($errors->has('description') ? 'is-invalid' : ''); ?>" type="text" name="description" id="description" value="<?php echo e(old('description', $blog->description)); ?>">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor <?php echo e($errors->has('detail_content') ? 'is-invalid' : ''); ?>" name="detail_content" id="detail_content"><?php echo old('detail_content', $blog->detail_content); ?></textarea>
