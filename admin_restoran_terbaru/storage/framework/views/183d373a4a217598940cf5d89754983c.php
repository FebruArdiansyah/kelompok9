          ...
          <div class="tab-content">
            <div class="tab-pane active show" id="tab-1">
              <div class="row">
                ...
                <div class="col-lg-4 text-center order-1 order-lg-2">
                  ...
                  <img
                    src="<?php echo e($b->getFirstMediaUrl('image', 'priview')); ?>"
                    alt=""
                    class="img-fluid"
                  />
            ...
            <div class="tab-pane" id="tab-2">
              <div class="row">
                ...
                <div class="col-lg-4 text-center order-1 order-lg-2">
                  <img
                    src="frontend/assets/img/specials-2.png"
                    alt=""
                    class="img-fluid"
                  />
                </div>
            ...
            <div class="tab-pane" id="tab-3">
              <div class="row">
                ...
                <div class="col-lg-4 text-center order-1 order-lg-2">
                  <img
                    src="frontend/assets/img/specials-3.png"
                    alt=""
                    class="img-fluid"
                  />
                </div>
            ...
            <div class="tab-pane" id="tab-4">
              <div class="row">
                ...
                <div class="col-lg-4 text-center order-1 order-lg-2">
                  <img
                    src="frontend/assets/img/specials-4.png"
                    alt=""
                    class="img-fluid"
                  />
                </div>
            ...
            <div class="tab-pane" id="tab-5">
              <div class="row">
                ...
                <div class="col-lg-4 text-center order-1 order-lg-2">
                  <img
                    src="frontend/assets/img/specials-5.png"
                    alt=""
                    class="img-fluid"
                  />
                </div>
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/frontend/special.blade.php ENDPATH**/ ?>