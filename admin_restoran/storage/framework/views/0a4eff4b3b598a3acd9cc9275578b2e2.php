      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
            <!-- tampil product sesuaidengan filter gudang garam -->
            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-lg-4 col-md-6 portfolio-item filter-<?php echo e(strtolower($p->category)); ?>">
                <div class="portfolio-wrap">
                    <img src="<?php echo e($p->getFirstMediaUrl('image', 'priview')); ?>" class="img-fluid" alt="">
                    <div class="portfolio-info">
                        <h4><?php echo e($p->name); ?></h4>
                        <p><?php echo e($p->category); ?></p>
                        <div class="portfolio-links">
                            <a href="<?php echo e($p->getFirstMediaUrl('image', 'priview')); ?>" data-gallery="portfolioGallery" class="portfolio-lightbox" title="<?php echo e($p->name); ?>"><i class="bx bx-plus"></i></a>
...
</html><?php /**PATH /var/www/html/resources/views/frontend/index.blade.php ENDPATH**/ ?>